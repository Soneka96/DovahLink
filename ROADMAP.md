...
| 3A | Active. Current interstitial stage between the released Stage 3 baseline and further Stage 4 product development; does not renumber Stage 4. 3A.1 and 3A.2 are complete; 3A.3 (Repository Normalization) is the remaining implementation work. | [Stage 3A — Host/Adapter Production Migration](roadmap/03a-host-adapter-production-migration.md) |
