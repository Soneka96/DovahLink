...
class FilesystemGameBehaviorConfigFileReader : public GameBehaviorConfigFileReader {
public:
...
[[nodiscard]] GameBehaviorConfig ReadGameBehaviorConfig(const GameBehaviorConfigFileReader& reader,
