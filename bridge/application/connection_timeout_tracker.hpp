...
/// Tracks the 5-second handshake and 60-second authenticated-idle deadlines for one connection.
/// Callers provide time explicitly; an expired connection cannot be revived by late activity.
