...
///  an optional ConsoleUtil Extended integration calls, forwarding each to
///  `service`. Carries no trust logic of its own -- see
...
///  @param service Trust-admin service every native function forwards to; must
///  outlive the Papyrus
