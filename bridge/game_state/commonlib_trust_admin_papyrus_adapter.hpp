...
/// Registers the native Papyrus functions (`DovahLinkAdmin.List/Revoke/Reset/Block/Unblock/Forget`)
...
/// surface". Registration succeeds unconditionally, independent of whether ConsoleUtil Extended or
/// its Papyrus glue script are actually installed; the registered functions simply go unused if
/// they are not.
