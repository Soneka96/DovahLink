...
///  the wire form of "final confirmation" in `security.md`'s pairing handshake
///  (`PENDING_CREDENTIAL -> TRUSTED`).
struct PairingAckPayload {
    ///  Hex-encoded credential the client received in a prior `credential_issued`
    ///  outcome.
