...
TEST_CASE("pairing-outcome-expired fixture decodes with no credential", "[protocol][pairing_outcome_payload]") {
...
TEST_CASE("pairing-outcome-invalid fixture decodes with no credential", "[protocol][pairing_outcome_payload]") {
