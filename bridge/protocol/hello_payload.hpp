...
struct HelloPayload {
    ...
    /// Identifier of the logical client establishing this connection. Shape-only here: a required
    /// non-empty string is enforced by the payload decoder; the application layer validates it
