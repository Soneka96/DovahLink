...
TEST_CASE("DecodeNonEmptyString accepts a non-empty string",
...
TEST_CASE("DecodeNonEmptyString rejects a null field pointer (missing field)",
          "[protocol][json_field_decoders]") {
    auto result = DecodeNonEmptyString(nullptr, "field");
    REQUIRE_FALSE(result.has_value());
}

TEST_CASE("DecodeNonEmptyString rejects an empty string",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeNonEmptyString rejects a non-string value",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeString accepts a non-empty string",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json(R"("hello")");
...
TEST_CASE("DecodeString accepts an empty string",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json(R"("")");
    auto result = DecodeString(&value, "field");
    REQUIRE(result.has_value());
...
TEST_CASE("DecodeString rejects a null field pointer (missing field)",
          "[protocol][json_field_decoders]") {
    auto result = DecodeString(nullptr, "field");
    REQUIRE_FALSE(result.has_value());
}

TEST_CASE("DecodeString rejects a non-string value",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json("5");
    auto result = DecodeString(&value, "field");
    REQUIRE_FALSE(result.has_value());
...
TEST_CASE("DecodeString rejects a JSON null value",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeString rejects a boolean value",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeString rejects an array value",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeNonNegativeInt accepts a positive int64",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeNonNegativeInt accepts zero",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeNonNegativeInt rejects a null field pointer (missing field)",
          "[protocol][json_field_decoders]") {
    auto result = DecodeNonNegativeInt(nullptr, "field");
    REQUIRE_FALSE(result.has_value());
}

TEST_CASE("DecodeNonNegativeInt rejects a negative integer",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeNonNegativeInt rejects a non-integer value",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeNonNegativeInt rejects a value too large to fit in int64",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeOptionalString treats an absent field pointer as no value",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeOptionalString treats a JSON null as no value",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json("null");
...
TEST_CASE("DecodeOptionalString accepts a non-empty string",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeOptionalString rejects an empty string",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json(R"("")");
    auto result = DecodeOptionalString(&value, "field");
    REQUIRE_FALSE(result.has_value());
...
TEST_CASE("DecodeOptionalString rejects a non-string, non-null value",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json("5");
    auto result = DecodeOptionalString(&value, "field");
    REQUIRE_FALSE(result.has_value());
...
TEST_CASE("DecodeOptionalString rejects a boolean value",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json("true");
    auto result = DecodeOptionalString(&value, "field");
    REQUIRE_FALSE(result.has_value());
...
TEST_CASE(
    "DecodeOptionalNonNegativeInt treats an absent field pointer as no value",
    "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeOptionalNonNegativeInt treats a JSON null as no value",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json("null");
...
TEST_CASE("DecodeOptionalNonNegativeInt accepts a non-negative integer",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json("42");
    auto result = DecodeOptionalNonNegativeInt(&value, "field");
    REQUIRE(result.has_value());
...
TEST_CASE("DecodeOptionalNonNegativeInt rejects a negative integer",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json("-1");
    auto result = DecodeOptionalNonNegativeInt(&value, "field");
    REQUIRE_FALSE(result.has_value());
...
TEST_CASE("DecodeStringArray accepts an array of non-empty strings",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeStringArray accepts an empty array",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeStringArray rejects a null field pointer (missing field)",
          "[protocol][json_field_decoders]") {
    auto result = DecodeStringArray(nullptr, "field");
    REQUIRE_FALSE(result.has_value());
}

TEST_CASE("DecodeStringArray rejects a non-array value",
          "[protocol][json_field_decoders]") {
...
TEST_CASE("DecodeStringArray rejects an array containing an empty string",
          "[protocol][json_field_decoders]") {
    boost::json::value value = Json(R"(["a", ""])");
    auto result = DecodeStringArray(&value, "field");
    REQUIRE_FALSE(result.has_value());
...
TEST_CASE("Fail wraps its reason in a DecodeError",
          "[protocol][json_field_decoders]") {
    auto result = Fail("something went wrong");
    CHECK(result.error().reason == "something went wrong");
}

TEST_CASE("RequireField returns the value for a present key",
          "[protocol][json_field_decoders]") {
...
TEST_CASE(
    "RequireField returns non-null for a present key whose value is JSON null",
    "[protocol][json_field_decoders]") {
...
TEST_CASE("RequireField returns nullptr for an absent key",
          "[protocol][json_field_decoders]") {
