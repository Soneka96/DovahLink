...
/// Runs Windows DPAPI protection behavior tests.
void main() {
  group('Behavior protect and unprotect round-trip behaves correctly', () {
    test(
      'Behavior protect and unprotect round-trip handles a normal payload',
      () {
    ...
    test(
      'Behavior protect and unprotect round-trip handles an empty payload',
      () {
  ...
  group('Method unprotect behaves correctly', () {
    test(
      'Method unprotect throws DovahLinkStorageException for bytes that are not a DPAPI blob',
      () {
        expect(
    ...
    test(
      'Method unprotect throws DovahLinkStorageException for an empty (zero-length) input',
      () {
        expect(
