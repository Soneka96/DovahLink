...
void main() {
  group('Method fromJson behaves correctly', () {
    ...
    test(
      'Method fromJson decodes the canonical state-event-duplicate fixture at the same '
    ...
    test(
      'Method fromJson decodes the canonical state-event-revision-gap fixture',
      () {
        final StateEventPayload payload = StateEventPayload.fromJson(
    ...
    test(
      'Method fromJson rejects fractional revision numbers instead of truncating them',
      () {
        expect(
          () => StateEventPayload.fromJson(<String, dynamic>{
            'stateArea': 'example_area',
    ...
    test(
      'Method fromJson rejects a fractional revision instead of truncating it',
      () {
        expect(
          () => StateEventPayload.fromJson(<String, dynamic>{
            'stateArea': 'example_area',
    ...
    test(
      'Method fromJson rejects a revision that does not follow baseRevision',
      () {
        expect(
          () => StateEventPayload.fromJson(<String, dynamic>{
            'stateArea': 'example_area',
    ...
    test(
      'Method fromJson throws ProtocolFormatException when baseRevision is missing',
      () {
        expect(
          () => StateEventPayload.fromJson(<String, dynamic>{
            'stateArea': 'example_area',
    ...
    test(
      'Method fromJson throws ProtocolFormatException when baseRevision is not an int',
      () {
        expect(
          () => StateEventPayload.fromJson(<String, dynamic>{
            'stateArea': 'example_area',
