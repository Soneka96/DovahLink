...
void main() {
  group('Method fromJson behaves correctly', () {
    ...
    test(
      'Method fromJson throws ProtocolFormatException when id is missing',
      () {
        expect(
    ...
    test(
      'Method fromJson throws ProtocolFormatException when version is missing',
      () {
        expect(
    ...
    test(
      'Method fromJson throws ProtocolFormatException when id is not a string',
      () {
        expect(
    ...
    test(
      'Method fromJson throws ProtocolFormatException when version is not an int',
      () {
        expect(
          () => Capability.fromJson(<String, dynamic>{
            'id': 'state.inventory',
            'version': 'one',
          }),
          throwsA(isA<ProtocolFormatException>()),
    ...
    test('Method fromJson round-trips through toJson', () {
      ...
      expect(
        Capability.fromJson(capability.toJson()).toJson(),
        capability.toJson(),
      );
    });
  });
  ...
  group('Method toJson behaves correctly', () {
    test('Method toJson encodes id and version', () {
      ...
      expect(capability.toJson(), <String, dynamic>{
        'id': 'state.inventory',
        'version': 1,
      });
    });
