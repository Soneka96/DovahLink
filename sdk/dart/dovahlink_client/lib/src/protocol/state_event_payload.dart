...
/// client never sends `state_event`. `data` stays an untyped [JsonMap] at the protocol boundary;
/// registered state domains decode it into typed SDK models. Contains complete post-change state,
/// not a patch.
