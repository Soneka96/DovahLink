...
/// client never sends `state_event`. `data` stays an untyped [JsonMap]: the schema registers five
/// state areas, but the SDK's typed domain models and synchronization API are Stage 5 work. Contains
