...
validation client and end-to-end scenarios driving a real native-plugin test-harness process --
were removed in `roadmap/03a-host-adapter-production-migration.md`'s 3A.2 ("Legacy Bridge
Removal") once the retired native plugin itself was deleted; they had no way to run against anything once their
