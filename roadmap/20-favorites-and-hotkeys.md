# Stage 20 — Favorites and Hotkeys

[Back to the roadmap index](../ROADMAP.md). [Previous stage](./19-magic-spells-shouts-and-powers.md) · [Next stage](./21-customizable-dashboard.md)
