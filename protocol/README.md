...
- The repository-root [`app/`](../app/), [`sdk/`](../sdk/), [`host/`](../host/), and [`adapter/`](../adapter/)
  areas contain adapters, not competing protocol definitions. Their locations are defined by the
  root [repository boundaries](../ARCHITECTURE.md#repository-boundaries).
