...
- The repository-root [`app/`](../app/) and planned `bridge/` areas, and the planned
  [`sdk/`](../sdk/) area, contain adapters, not competing protocol definitions. Their locations are
  defined by the root [repository boundaries](../ARCHITECTURE.md#repository-boundaries).
