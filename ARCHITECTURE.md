...
Defines connection, pairing, capability, state, and error messages between the bridge and clients. The first version should be intentionally narrow and easy to inspect.
