  ...
  group('Behavior pairing visual tokens behave correctly', () {
    test(
      ...
      () {
        expect(
          <Object>[
            DovahThemeTokens.pairingCodeBoxWidth,
            DovahThemeTokens.pairingCodeBoxHeight,
            ...
            DovahThemeTokens.formErrorMinHeight,
            DovahThemeTokens.dialogActionGap,
            DovahThemeTokens.pairingContentMaxWidth,
            DovahThemeTokens.pairingBodyMaxWidth,
            DovahThemeTokens.pairingMarkSize,
            DovahThemeTokens.pairingMarkIconSize,
            DovahThemeTokens.pairingMarkBottomGap,
            DovahThemeTokens.pairingHeadingFontSize,
            DovahThemeTokens.pairingHeadingBottomGap,
            DovahThemeTokens.pairingBodyFontSize,
            DovahThemeTokens.pairingBodyLineHeight,
            DovahThemeTokens.pairingBodyBottomGap,
            DovahThemeTokens.pairingNoteFontSize,
            DovahThemeTokens.pairingNoteTopGap,
      ...
      () {
        expect(
          <Object>[
            ...
            DovahThemeTokens.buttonIconSize,
            DovahThemeTokens.buttonIconGap,
            ...
            DovahThemeTokens.dialogHeightFraction,
