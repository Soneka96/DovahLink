...
void main() {
  ...
  Future<Color> paintOverRed(
    ...
    final Canvas canvas = Canvas(recorder)
      ..drawRect(Offset.zero & size, Paint()..color = red);
    DovahBackdropPainter(backdrop: backdrop).paint(canvas, size);
    final Image image = await recorder.endRecording().toImage(8, 8);
