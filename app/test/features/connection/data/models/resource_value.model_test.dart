...
void main() {
  test('ResourceValueModel maps JSON and is usable as its entity', () {
  ...
  test('ResourceValueModel rejects missing and non-finite values', () {
    expect(
      () => ResourceValueModel.fromJson({'current': 1}),
      throwsA(isA<FormatException>()),
    );
    expect(
      () => ResourceValueModel.fromJson({'current': double.nan, 'maximum': 2}),
      throwsA(isA<FormatException>()),
    );
  });
}
