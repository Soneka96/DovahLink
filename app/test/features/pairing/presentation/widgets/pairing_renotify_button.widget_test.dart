...
void main() {
  group('PairingRenotifyButton', () {
    testWidgets(
      'PairingRenotifyButton displays enabled button when renotify is available',
    ...
    testWidgets(
      'PairingRenotifyButton displays disabled button during cooldown',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'PairingRenotifyButton shows cooldown seconds in default format',
      (WidgetTester tester) async {
        final now = DateTime.now();
    ...
    testWidgets(
      'PairingRenotifyButton treats zero cooldown seconds as available',
      (WidgetTester tester) async {
        final now = DateTime.now();
    ...
    testWidgets(
      'PairingRenotifyButton uses custom cooldown label when provided',
      (WidgetTester tester) async {
        final now = DateTime.now();
        final availableIn5Seconds = now.add(const Duration(seconds: 5));
        final store = Store<AppState>(
    ...
    testWidgets(
      'PairingRenotifyButton dispatches PairingRenotifyRequestedAction on tap',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'PairingRenotifyButton does not dispatch action during cooldown',
      (WidgetTester tester) async {
        final now = DateTime.now();
        final availableIn5Seconds = now.add(const Duration(seconds: 5));
        final actions = <dynamic>[];
