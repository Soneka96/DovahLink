...
/// (`protocol/schema/README.md`'s "Common envelope"). Deliberately self-contained to this client
/// library rather than shared with `features/connection/data/models/protocol_envelope.model.dart`:
/// that feature is expected to depend on this client once it is wired in, not the reverse.
