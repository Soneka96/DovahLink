...
/// <param name="SkyrimInstallPath">The optional Skyrim / Creation Kit install path selected through Settings, preferred when locating the Papyrus compiler.</param>
