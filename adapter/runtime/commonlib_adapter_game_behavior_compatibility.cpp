...
//  the same technique already ported once into `bridge/`, translated to this
//  project's pinned CommonLibSSE-NG, which exposes REL::safe_fill/safe_write
//  free functions where that reference's CommonLibSSE fork exposes
//  Relocation::write_fill/write member functions instead.
